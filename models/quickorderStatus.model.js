...
const QuickOrderStatusSchema = new Schema({
  ...
  measurementAlterationID: { type: mongoose.Schema.Types.ObjectId, ref: "CustomerMesurmentAlteration" },
  specialIntructionAlterationID: { type: mongoose.Schema.Types.ObjectId, ref: "CustomerSpacialInstructionAltreation" },
...
const QuickOrderStatus = mongoose.model('QuickOrderStatus', QuickOrderStatusSchema);
